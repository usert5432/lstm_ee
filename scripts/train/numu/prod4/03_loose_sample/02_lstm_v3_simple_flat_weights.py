"""Train family of LSTM v3 networks on a loose sample with different weights"""
...
config = join_dicts(
    ...
    # Args:
        ...
        'vars_mod_slice'  : None,
        'outdir'          :
            'numu/prod4/03_loose_sample/02_lstm_v3_simple_flat_weights/',
    }
)
...
search_space = [
    ...
    },
    {
        'weights' : {
            'name'   : 'flat',
            'kwargs' : { 'bins' : 50, 'range' : (0, 7) },
        }
    },
    {
        'weights' : {
            'name'   : 'flat',
            'kwargs' : { 'bins' : 70, 'range' : (0, 7) },
        }
    },
    {
        'weights' : {
            'name'   : 'flat',
            'kwargs' : { 'bins' : 35, 'range' : (0, 7) },
        }
    },
]
